...
mysql -u$newUser -p$password < ~/go/src/github.rtp.raleigh.ibm.com/bluemix/docker-broker/broker/setup.sql 

/etc/init.d/mysql stop

mysqld_safe &
cd /go/src/github.rtp.raleigh.ibm.com/bluemix/docker-broker/broker
